                ...
                <%  
                                                ...
                                                try 
                                              {
                                                  Class.forName("com.mysql.jdbc.Driver");
                                                      ...
                                                      String placementdetail = request.getParameter("placementdetail");
                                                      System.err.println("placementdetail from  page:" + placementdetail);

                                                  
                                                      String query = "Select * from placement where placementdetail= '" + placementdetail + "'";
